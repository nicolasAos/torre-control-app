...
// export const baseURLHomolog = 'https://hml-gateway.agv.com.br/services/market-place/';
//export const baseURLHomolog = 'https://hml-gateway.agv.com.br/proxy/torre-control/api-agv/services/agv-parceiro/';

export const baseURLHomolog =
  'http://strackqa.solistica.com/api-agv/services/agv-parceiro/';

const ApiRemittancesService = axios.create({
  baseURL,
  headers: {'Content-Type': 'application/json'},
});

ApiRemittancesService.interceptors.request.use(
  async (config) => {
    ...
    console.log('ApiUrl: ', config.baseURL);
...
createAuthRefreshInterceptor(ApiRemittancesService, refreshAuthLogic);
console.log('ApiObject: ', ApiRemittancesService);

export default ApiRemittancesService;
