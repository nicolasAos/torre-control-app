...
export const baseURL = 'https://annuit.solistica.com/';
/*
export const baseURLHomolog =
  'https://hml-gateway.agv.com.br/proxy/torre-control/';
*/
export const baseURLHomolog = 'http://strackqa.solistica.com/';
...
createAuthRefreshInterceptor(globalApi, refreshAuthLogic);
