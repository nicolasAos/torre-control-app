...
export const baseURL =
  'https://annuit.solistica.com/api-agv/services/agv-parceiro/';
/*
...
const apiNovedadesSacReport = axios.create({
  baseURL,
  headers: {'Content-Type': 'application/json'},
});

apiNovedadesSacReport.interceptors.request.use(
  async (config) => {
...
createAuthRefreshInterceptor(apiNovedadesSacReport, refreshAuthLogic);

export default apiNovedadesSacReport;
